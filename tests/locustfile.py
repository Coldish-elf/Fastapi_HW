...
class AuthenticatedFastAPIUser(HttpUser):
    ...
    def on_start(self):
        ...
        if (
            ...
            and response_register.status_code != 409
        ):
            return
...
class ReadHeavyUser(AuthenticatedFastAPIUser):
    ...
    def get_tasks_with_filters(self):
        ...
        if random.random() < 0.5:
            params["sort_by"] = random.choice(
                ["title", "status", "created_at", "priority", "id"]
            )
        if random.random() < 0.4:
            params["search"] = random.choice(
                ["task", "test", "important", "api", "locust"]
            )
        ...
        self.client.get(
            "/tasks", headers=headers, params=params, name="/tasks (get with filters)"
        )
...
class WriteHeavyUser(AuthenticatedFastAPIUser):
    ...
    def update_random_task(self):
        ...
        with self.client.get(
            ...
            headers=headers,
            params={"limit": 5},
            name="/tasks (get for update)",
            catch_response=True,
        ) as response_get:
            if not response_get.ok:
                response_get.failure(
                    f"Get for update failed: {response_get.status_code}"
                )
                return
            try:
                ...
                response_get.failure(
                    f"Get for update returned invalid JSON: {response_get.text}"
                )
                return
            ...
            with self.client.put(
                ...
                if not response_put.ok:
                    response_put.failure(
                        f"Update task {task_id} failed: {response_put.status_code} - {response_put.text}"
                    )
    ...
    def delete_random_task(self):
        ...
        with self.client.get(
            ...
            headers=headers,
            params={"limit": 5},
            name="/tasks (get for delete)",
            catch_response=True,
        ) as response_get:
            if not response_get.ok:
                response_get.failure(
                    f"Get for delete failed: {response_get.status_code}"
                )
                return
            try:
                tasks = response_get.json()
                ...
                response_get.failure(
                    f"Get for delete returned invalid JSON: {response_get.text}"
                )
                return
            ...
            with self.client.delete(
                ...
                if not response_delete.ok:
                    response_delete.failure(
                        f"Delete task {task_id} failed: {response_delete.status_code} - {response_delete.text}"
                    )
    ...
    def test_list_cache_invalidation_after_create(self):
        ...
        create_data = {
            ...
            "description": "Testing list cache invalidation",
            "status": "в ожидании",
            "priority": 1,
        }
        new_task_id = None
        with self.client.post(
            ...
            headers=headers,
            json=create_data,
            name="/tasks (list_cache_inval_post)",
            catch_response=True,
        ) as response_create:
            if not response_create.ok:
                response_create.failure(
                    f"List_cache_inval_post failed: {response_create.status_code} - {response_create.text}"
                )
                return
            try:
                ...
                response_create.failure(
                    f"List_cache_inval_post did not return task ID: {response_create.text}"
                )
                return
        ...
        with self.client.get(
            ...
            headers=headers,
            params=list_params,
            name="/tasks (list_cache_inval_get_after_create)",
            catch_response=True,
        ) as response_get_list:
            if not response_get_list.ok:
                response_get_list.failure(
                    f"List_cache_inval_get_after_create failed: {response_get_list.status_code} - {response_get_list.text}"
                )
                return
            try:
                ...
                if not found_new_task:
                    response_get_list.failure(
                        f"List_cache_inval_get_after_create: New task {new_task_id} not found in list."
                    )
                else:
                    response_get_list.success()
            except (TypeError, KeyError, ValueError):
                response_get_list.failure(
                    f"List_cache_inval_get_after_create returned invalid JSON: {response_get_list.text}"
                )
...
class MixedUsageUser(AuthenticatedFastAPIUser):
    ...
    def get_tasks(self):
        ...
        if random.random() < 0.3:
            params["sort_by"] = random.choice(
                ["title", "status", "created_at", "priority"]
            )
        if random.random() < 0.2:
        ...
        self.client.get(
            "/tasks", headers=headers, params=params, name="/tasks (mixed get)"
        )
    ...
    def create_task(self):
        ...
        self.client.post(
            "/tasks", headers=headers, json=task_data, name="/tasks (mixed post)"
        )
    ...
    def update_or_delete_task(self):
        ...
        with self.client.get(
            ...
            headers=headers,
            params={"limit": 5},
            name="/tasks (mixed get for update/delete)",
            catch_response=True,
        ) as response_get:
            if not response_get.ok:
                response_get.failure(
                    f"Mixed get for update/delete failed: {response_get.status_code}"
                )
                return
            try:
                tasks = response_get.json()
                ...
                response_get.failure(
                    f"Mixed get for update/delete returned invalid JSON: {response_get.text}"
                )
                return
        ...
        if random.random() < 0.7:
            ...
            with self.client.put(
                ...
                headers=headers,
                json=update_data,
                name="/tasks/{id} (mixed put)",
                catch_response=True,
            ) as response_put:
                if not response_put.ok:
                    response_put.failure(
                        f"Mixed update task {task_id} failed: {response_put.status_code} - {response_put.text}"
                    )
        else:
            with self.client.delete(
                f"/tasks/{task_id}",
                headers=headers,
                name="/tasks/{id} (mixed delete)",
                catch_response=True,
            ) as response_delete:
                if not response_delete.ok:
                    response_delete.failure(
                        f"Mixed delete task {task_id} failed: {response_delete.status_code} - {response_delete.text}"
                    )
...
class CacheBenchmarkUser(AuthenticatedFastAPIUser):
    ...
    def get_tasks_with_static_params_for_cache_potential(self):
        ...
        with self.client.get(
            "/tasks",
            headers=headers,
            params=self.static_params_for_cache_test,
            name="/tasks (static_params_cache_potential)",
            catch_response=True,
        ) as response:
            if not response.ok:
                response.failure(
                    f"Static params cache potential failed: {response.status_code} - {response.text}"
                )
    ...
    def get_tasks_repeatedly_for_cache_hit(self):
        ...
        with self.client.get(
            ...
            headers=headers,
            params=self.static_params_for_cache_test,
            name="/tasks (cache_hit_test_first_call)",
            catch_response=True,
        ) as response1:
            if not response1.ok:
                response1.failure(
                    f"Cache_hit_test_first_call failed: {response1.status_code} - {response1.text}"
                )
                return
        ...
        with self.client.get(
            ...
            headers=headers,
            params=self.static_params_for_cache_test,
            name="/tasks (cache_hit_test_second_call)",
            catch_response=True,
        ) as response2:
            if not response2.ok:
                response2.failure(
                    f"Cache_hit_test_second_call failed: {response2.status_code} - {response2.text}"
                )
    ...
    def get_tasks_dynamic_params(self):
        ...
        with self.client.get(
            ...
            headers=headers,
            params=params,
            name="/tasks (dynamic get)",
            catch_response=True,
        ) as response:
            if not response.ok:
                response.failure(
                    f"Dynamic get failed: {response.status_code} - {response.text}"
                )
    ...
    def get_tasks_with_no_cache_header(self):
        ...
        with self.client.get(
            ...
            params=self.static_params_for_cache_test,
            name="/tasks (no-cache header)",
            catch_response=True,
        ) as response:
            if not response.ok:
                response.failure(
                    f"No-cache header get failed: {response.status_code} - {response.text}"
                )
...
class APICreationStressUser(AuthenticatedFastAPIUser):
    ...
    def stress_create_task(self):
        ...
        self.client.post(
            "/tasks", headers=headers, json=task_data, name="/tasks (stress post)"
        )
